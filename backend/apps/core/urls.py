...
urlpatterns = [
    ...
    # S3 Configuration and Testing
    path('s3/test/', s3_config.test_s3_connection, name='s3-test'),
    path('s3/config/', s3_config.s3_config_info, name='s3-config'),
    path('s3/enable/', s3_config.enable_s3_storage, name='s3-enable'),
